...
{
  QF_ASSERT(payoffType == 1 || payoffType == -1, "AsianBasketCallPut: the payoff type must be 1 (call) or -1 (put)!");
  QF_ASSERT(strike >= 0.0, "AsianBasketCallPut: the strike must be positive!");
  QF_ASSERT(fixingTimes[0] >= 0.0,
